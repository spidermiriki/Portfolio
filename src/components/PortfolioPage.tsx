...
const TRANSLATIONS: Record<Lang, Translation> = {
  fr: {
    ...
    projects: {
      ...
      homepage: {
        tag: 'Personnel · 2026', title: 'Homepage',
      ...
      melo: {
        tag: 'Personnel · 2026', title: "Melo's Studio",
      ...
      videoconf: {
        tag: 'HEH DST · Cours React · 2026', title: 'VideoConf Hub',
      ...
      marine: {
        tag: 'Personnel · 2026 — En cours', title: 'Evolution Marine',
        sub: 'Godot 4 · GDScript · Jeu 2D · Simulation',
        desc: "Jeu de simulation d'évolution marine en 2D développé sous Godot 4. Incarnez des créatures marines et évoluez à travers un système d'espèces dynamique. Optimisé mobile, disponible en deux versions (Godot 4.6 et 4.7). Projet actuellement en développement.",
        corner: 'Godot Engine',
      },
    },
  ...
  en: {
    ...
    projects: {
      ...
      homepage: {
        tag: 'Personal · 2026', title: 'Homepage',
      ...
      melo: {
        tag: 'Personal · 2026', title: "Melo's Studio",
      ...
      videoconf: {
        tag: 'HEH DST · React Course · 2026', title: 'VideoConf Hub',
        sub: 'React 19 · Firebase · YouTube Data API v3 · GitHub Actions',
      ...
      marine: {
        tag: 'Personal · 2065 — In progress', title: 'Evolution Marine',
        sub: 'Godot 4 · GDScript · 2D Game · Simulation',
        desc: 'A 2D marine evolution simulation game built in Godot 4. Play as sea creatures and evolve through a dynamic species system. Mobile-optimized, available in two versions (Godot 4.6 and 4.7). Project currently in development.',
        corner: 'Godot Engine',
      },
    },
  ...
  es: {
    ...
    projects: {
      ...
      videoconf: {
        tag: 'HEH DST · Curso React · 2026', title: 'VideoConf Hub',
        sub: 'React 19 · Firebase · YouTube Data API v3 · GitHub Actions',
      ...
      marine: {
        tag: 'Personal · 2026 — En desarrollo', title: 'Evolution Marine',
        sub: 'Godot 4 · GDScript · Juego 2D · Simulación',
        desc: 'Un juego 2D de simulación de evolución marina desarrollado en Godot 4. Juega como criaturas marinas y evoluciona a través de un sistema dinámico de especies. Optimizado para móvil, disponible en dos versiones (Godot 4.6 y 4.7). Proyecto actualmente en desarrollo.',
        corner: 'Godot Engine',
      },
    },
